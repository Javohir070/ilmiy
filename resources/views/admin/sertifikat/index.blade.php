...
<div class="content">
    ...
    <div class="flex w-100 justify-between align-center">
        <h2 class="intro-y text-lg font-medium mt-10">Sertifikat</h2>


        <div class="flex w-100 justify-between align-center">
            <a href="/education_unconfirmed/" class="button bg-theme-9 text-white mt-10">
            Tasdiqlanmaganlar 0</a>
            <a href="#" class="button bg-theme-6 text-white mt-10">
            Rad qilinganlar 0</a>
        </div>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
            <div class="w-full mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                <form method="POST" action="{{ route('sertifikat.store') }}" class="validate-form" enctype="multipart/form-data"
        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <table class="table table-report -mt-2">
                ...
                <tr class="intro-x">
                        <td>{{$loop->index+1}}</td>
                        <td>
                            <a href="/files/papers/4735cda0-a7a3-4a45-bd93-0bc013b857dc.png" target="_blank" download="/files/papers/4735cda0-a7a3-4a45-bd93-0bc013b857dc.png" class="font-medium">{{ $sert->name }}</a>
                        </td>
                        <td>
                            <a href="" class="font-medium ">{{ $sert->tashkilot_name  }}</a>
                        </td>
                        <td>
                            <a href="" class="font-medium ">{{ $sert->sana }}</a>
                        </td>
                        <td class="w-40">
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                ...
                                <form action="{{ route('sertifikat.destroy',['sertifikat'=>$sert->id]) }}" method="post" onsubmit="return confirm(' Rostan Ochirishni hohlaysizmi?');">

            ...
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        ...
                        <th class="whitespace-no-wrap">Ixtiro nami</th>
                        <th class="whitespace-no-wrap">Mualliflari soni</th>
                        <th class="whitespace-no-wrap">Mualliflari</th>
                        <th class="whitespace-no-wrap">Guvohnoma raqami</th>
                        <th class="whitespace-no-wrap">Olingan sanasi</th>
                ...
                <tbody>
                    ...
                    <tr class="intro-x">
                        ...
                        <td>
                            <a href="" class="font-medium ">{{ $maq->mualliflar_soni }}</a>
                        </td>
                        <td>
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                             ...
                             <form action="{{ route('ixtiro.destroy',['ixtiro'=>$maq->id]) }}" method="post" onsubmit="return confirm(' Rostan Ochirishni hohlaysizmi?');">
                            ...
                            <form id="science-paper-create-form" method="POST" action="{{ route('ixtiro.store') }}" class="validate-form" enctype="multipart/form-data" novalidate="novalidate">
                                ...
                                <div class="grid grid-cols-12 gap-2">
                                    ...
                                    <div class="w-full col-span-6">
                                        <label class="flex flex-col sm:flex-row"> <span class="mt-1 mr-1 sm:mt-0 text-xs text-red-600">*</span> Intelektual faoliyat turi
                                        </label>
                                        <select name="categoriy" id="science-sub-category" class="input border w-full mt-2" required="">
                                            ...
                                            <option value="4">Selektsiya yutuqlari(O'simlik davri)</option>

                                            <option value="5">Selektsiya yutuqlari(Hayvon zotlari)</option>

                                            <option value="6">Tovar belgisi</option>

                                            <option value="7">Tovar kelib chiqqan joy nomi</option>

                                            <option value="8">Geografik ko'rsatgichlar</option>

                                            <option value="9">Hammaga ma'lum Tovar belgisi</option>

                                            <option value="10">Ma'lumot belgisi</option>

                                            <option value="11">EHM uchun yaratilgan dastur</option>

                                            <option value="12">Integral sxemalar</option>
                                    ...
                                    <div class="w-full col-span-6">
                                        ...
                                        <input type="text" id="datepicker" name="sana" class="datepicker input w-full border mt-2" required="">

                                    </div>

                                    
                                    <div class="w-full col-span-12 ilmiy-ish">
                                        <label class="flex flex-col sm:flex-row"> <span class="mt-1 mr-1 sm:mt-0 text-xs text-red-600">*</span> Ixtiro nomi
                                        </label>
                                        <input type="text" name="name" class="input w-full border mt-2" required="">
                                    </div>
                                    <div class="w-full col-span-6">
                                        <label class="flex flex-col sm:flex-row"> <span class="mt-1 mr-1 sm:mt-0 text-xs text-red-600">*</span> Mualliflar soni
                                        </label>
                                    ...
                                    <div class="w-full col-span-6 ilmiy-ish">
                                        <label class="flex flex-col sm:flex-row"><span class="mt-1 mr-1 sm:mt-0 text-xs text-red-600">*</span> Guvohnoma raqami
                                        </label>
                                    ...
                                    <div class="w-full col-span-12">
                                        ...
                                        <label class="flex flex-col sm:flex-row"> <span class="mt-1 mr-1 sm:mt-0 text-xs text-red-600">*</span> Faylni yukllash
                                        </label>

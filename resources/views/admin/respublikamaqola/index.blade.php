...
<div class="content">
    <div class="flex justify-between align-center mt-10">
        ...
        <h2 class="intro-y text-lg font-medium">Xalqaro Maqola</h2>
            ...
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        ...
                        <th class="whitespace-no-wrap">Xalqaro maqola nomi</th>
                        <th class="whitespace-no-wrap">Chiqarilgan jurnal</th>
                ...
                <tbody>
                    ...
                    @foreach ($x_maqola as $maq )

                    <tr class="intro-x">
                        <td>{{$loop->index+1}}</td>
                        <td>
                            <a href="/files/papers/4735cda0-a7a3-4a45-bd93-0bc013b857dc.png" target="_blank" download="/files/papers/4735cda0-a7a3-4a45-bd93-0bc013b857dc.png" class="font-medium">{{ $maq->title }}</a>
                        </td>
                        <td>
                            <a href="" class="font-medium ">{{ $maq->jurnal  }}</a>
                        </td>
                        <td>
                            <a href="" class="font-medium ">{{ $maq->link }}</a>
                        </td>
                        <td>
                            <a href="" class="font-medium ">{{ $maq->yil }}</a>
                        </td>
                        <td class="w-40">
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                ...
                                <form action="{{ route('xalqromaqola.destroy',['xalqromaqola'=>$maq->id]) }}" method="post" onsubmit="return confirm(' Rostan Ochirishni hohlaysizmi?');">
                ...
                <div class="p-5">
                    ...
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
                        <div class="w-full mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                            <form id="science-paper-create-form" method="POST" action="{{ route('xalqromaqola.store') }}" class="validate-form" enctype="multipart/form-data" novalidate="novalidate">
                                @csrf
                                <div class="grid grid-cols-12 gap-2">
                                    <input name="id" type="hidden">
                                    <div class="w-full col-span-6">
                                        <label class="flex flex-col sm:flex-row"> <span class="mt-1 mr-1 sm:mt-0 text-xs text-red-600">*</span> Xalqaro maqola turi
                                        </label>
                                        <select name="categoriy" id="science-sub-category" class="input border w-full mt-2" required="">

                                            <option value="0">tanlash</option>

                                            <option value="1">Xalqaro Maqola</option>

                                            <option value="2">Xalqaro tezis</option>

                                            <option value="3">Respublika maqola </option>
                                            
                                            <option value="4"> Respublika tezis </option>


                                        </select>
                                    </div>
                                    <div class="w-full col-span-6 ilmiy-ish">
                                        <label class="flex flex-col sm:flex-row"> <span class="mt-1 mr-1 sm:mt-0 text-xs text-red-600">*</span>Xalqaro maqola
                                            bazalar
                                        </label>
                                    ...
                                    <div class="w-full col-span-12 ilmiy-ish">
                                        <label class="flex flex-col sm:flex-row"> <span class="mt-1 mr-1 sm:mt-0 text-xs text-red-600">*</span> Xalqaro maqola nomi
                                        </label>
                                        <input type="text" name="title" class="input w-full border mt-2" required="">
                                    </div>
                                    <div class="w-full col-span-12 ilmiy-ish">
                                        <label class="flex flex-col sm:flex-row"> <span class="mt-1 mr-1 sm:mt-0 text-xs text-red-600">*</span> Ishtirokchilar
                                        </label>
                                        <textarea name="ishtirokchilar"  class="input w-full border mt-2"  ></textarea>
                                    </div>
                                    <div class="w-full col-span-6" style="display: none;">
                                        ...
                                        <input type="number" class="input w-full border mt-2" required="">
                                    </div>



                                    <div class="w-full col-span-6 ilmiy-ish">
                                        <label class="flex flex-col sm:flex-row"> Link
                                        </label>
                                        <input type="text" name="link" class="input w-full border mt-2">
                                    </div>
                                    <div class="w-full col-span-6">
                                        <label class="flex flex-col sm:flex-row"> <span class="mt-1 mr-1 sm:mt-0 text-xs text-red-600">*</span> Sana
                                        </label>
                                        <input type="text" id="datepicker" name="yil" class="datepicker input w-full border mt-2" required="">

                                    </div>
                                    <div class="w-full col-span-12 ilmiy-ish">
                                        <label class="flex flex-col sm:flex-row"><span class="mt-1 mr-1 sm:mt-0 text-xs text-red-600">*</span> Jurnal nomi
                                        </label>
                                        <input type="text" name="jurnal" class="input w-full border mt-2" required="">
                                    </div>

...
<div class="content">
    <div class="flex justify-between align-center mt-10">
        ...
        <h2 class="intro-y text-lg font-medium">Ilmiy daraja</h2>
            ...
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        ...
                        <th class="whitespace-no-wrap">Ilmiy daraja</th>
                ...
                <tbody>
                    ...
                    <tr class="intro-x">
                        <td>{{$loop->index+1}}</td>
                        <td>
                            <a href="#" target="_blank"  class="font-medium">{{ $maq->ilmiy_daraja_nomi }}</a>
                        </td>
                        <td>
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                ...
                                <form action="{{ route('ilmiydaraja.destroy',['ilmiydaraja'=>$maq->id]) }}" method="post" onsubmit="return confirm(' Rostan Ochirishni hohlaysizmi?');">
                ...
                <div class="p-5">
                    ...
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
                        <div class="w-full mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                            <form id="science-paper-create-form" method="POST" action="{{ route('ilmiydaraja.store') }}" class="validate-form" enctype="multipart/form-data" novalidate="novalidate">
                                @csrf
                                <div class="grid grid-cols-12 gap-2">
                                    <div class="w-full col-span-6">
                                        ...
                                        <select name="ilmiy_daraja_nomi" id="science-sub-category" class="input border w-full mt-2" required="">

                                            <option value="0">Ilmiy daraja tanlang</option>

                                            <option value="Phd">Phd</option>

                                            <option value="DSc">DSc</option>

                                            <option value="Pan nomzodi">Pan nomzodi</option>
                                           
                                            <option value="Pan doktori">Pan doktori</option>
